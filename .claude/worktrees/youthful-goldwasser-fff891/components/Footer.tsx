...
const LISTEN = [
  ...
  { label: "YouTube Music", href: "https://music.youtube.com/", Icon: YouTubeIcon },
];

const FOLLOW = [
  { label: "Instagram", href: "https://instagram.com/malicantsing", Icon: InstagramIcon },
  { label: "TikTok", href: "https://tiktok.com/@malicantsing", Icon: TikTokIcon },
  { label: "YouTube", href: "https://youtube.com/@malicantsing", Icon: YouTubeIcon },
];
    ...
    <footer className="relative mt-section md:mt-section-lg" aria-label="Site footer">
      <div className="mx-auto max-w-page px-gutter md:px-gutter-md lg:px-gutter-lg">
        ...
        <div className="py-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 font-mono text-mono-xs uppercase tracking-caps-md text-ink-3">
          <div>© {YEAR} akilah mali — all songs &amp; images</div>
          <div>brooklyn, n.y. · site v.01</div>
          <div>
            press &amp; sync &nbsp;·&nbsp;{" "}
