...
export function WhoReallyWon() {
  ...
  return (
    // Landing: an in-flow hero (so the page scrolls to the subscribe footer
    // below) with the site Header on top. Once the visitor enters the control
    // room we go fixed + lift above the header for the full-screen takeover.
    <div
      className={`${
        entered
          ? "fixed inset-0 z-[80]"
          : "relative z-40 h-[115svh]"
