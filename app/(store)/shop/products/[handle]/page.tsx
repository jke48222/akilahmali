...
export async function generateMetadata(
  ...
  try {
    ...
    return {
      title: product.title,
      description: product.description?.slice(0, 200) ?? `${product.title} — MALI shop.`,
      alternates: { canonical: `/shop/products/${handle}` },
      openGraph: {
        title: `${product.title} — MALI`,
        description: product.description?.slice(0, 200) ?? `${product.title} — MALI shop.`,
            ...
            <div className="md:sticky" style={{ top: "96px" }}>
              ...
              <div className="mt-10 border-b border-rule">
                ...
                <Disc title="shipping & returns">
                  <p className="max-w-[58ch]">
                    Ships from Brooklyn within 5 business days. Domestic $6 flat,
