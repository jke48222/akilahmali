...
export async function generateMetadata(
  ...
  const description =
    live ? portableTextToPlain(live.description) || `MALI — ${title}` : fallback!.blurb;
...
function mergeWithStatic(
  ...
  return {
    ...
    upc: fallback.upc,
    label: fallback.label ?? "malicantsing music · self-released",
    ...
    <>
      ...
      <section className="relative" style={{ minHeight: "100svh" }}>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(244,242,238,0), rgba(244,242,238,1))",
          }}
        />
      ...
      <section className="relative">
        <div className="mx-auto max-w-page px-gutter md:px-gutter-md lg:px-gutter-lg pt-section md:pt-section-md">
          <Reveal>
            <SectionLabel index="01 / listen" label={`${platforms.length || 4} platforms`} />
          </Reveal>
          <Reveal delay={120}>
                    ...
                    <span className="flex items-baseline gap-5">
                      ...
                      >
                        ...
                        {"primary" in p && p.primary ? (
                          <span className="font-mono text-mono-xs uppercase tracking-caps-md ml-3 text-accent">
                            · primary
                          </span>
                        ) : null}
                      </span>
      ...
      <section className="relative">
        <div className="mx-auto max-w-page px-gutter md:px-gutter-md lg:px-gutter-lg pt-section md:pt-section-xl">
          <Reveal>
            <SectionLabel
              index="02 / tracklist"
              label={`${release.tracks.length} tracks · ${release.runtime}`}
            />
          </Reveal>
          {release.blurb ? (
            <Reveal delay={120}>
            ...
            <ul className="mt-12 md:mt-16 border-b border-rule">
              {release.tracks.map((t, i) => (
                <Track
                  ...
                  meta={[`written by — akilah mali`, `recorded — ${release.year}, brooklyn`]}
                />
              ))}
            </ul>
          </Reveal>
          <Reveal delay={260}>
            <div className="mt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 font-mono text-mono-xs uppercase tracking-caps-md text-ink-3">
              ...
              <span>
                all lyrics © {release.year} akilah mali · malicantsing music · ascap
              </span>
            </div>
          </Reveal>
        </div>
        ...
        <section className="relative">
          <div className="mx-auto max-w-page px-gutter md:px-gutter-md lg:px-gutter-lg pt-section md:pt-section-xl">
            <Reveal>
              <SectionLabel
                index="03 / video"
                label={`${video.title.toLowerCase()} — ${video.kindLabel}`}
              />
            </Reveal>
            <Reveal delay={120}>
              <div className="mt-8 md:mt-10 grid grid-cols-12 gap-3 items-end">
                <h2
                  className="col-span-12 md:col-span-8 font-display italic leading-[0.95] tracking-mark"
              ...
              <div className="mt-8 md:mt-10 relative" style={{ padding: "4px", background: "var(--color-ink)" }}>
                <LiteYouTube
                  ...
                  burns={{
                    ...
                    topRight: "16:9 · 1080p",
                    bottomLeft: `mali — ${video.title.toLowerCase()}`,
            ...
            <Reveal delay={260}>
              <div className="mt-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 font-mono text-mono-xs uppercase tracking-caps-md text-ink-3">
                <span>video plays inline · captions available</span>
                <a
      ...
      <section className="relative">
        <div className="mx-auto max-w-page px-gutter md:px-gutter-md lg:px-gutter-lg pt-section md:pt-section-xl">
          <Reveal>
            <SectionLabel index="04 / credits" label="colophon" />
          </Reveal>
          <div className="grid grid-cols-12 gap-6 md:gap-10 mt-10 md:mt-14">
            <Reveal as="div" className="col-span-12 md:col-span-4">
              ...
              >
                a small <br /> credit roll.
              </h2>
              <p className="mt-5 max-w-[40ch] text-[15px] leading-[1.65] text-ink-2">
                made by hand, mostly at home. a few rooms borrowed. one good microphone.
              </p>
            </Reveal>
            <Reveal as="div" delay={120} className="col-span-12 md:col-span-8">
              ...
              <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6 font-mono text-mono-xs uppercase tracking-caps-md text-ink-3">
                ...
                <div>
                  ...
                  <div className="mt-1">malicantsing</div>
                </div>
              </div>
            </Reveal>
          </div>
              ...
              {next ? (
                ...
                <div>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="mt-2 font-mono text-mono-xs uppercase tracking-caps-md text-ink-3">
                      no date — &nbsp;
                      <NextLink href="/#next" className="ulink text-accent">
                        for the next one
                      </NextLink>
                    </div>
                  </div>
  ...
  const payload = isAlbum
    ? {
        ...
        track: release.tracks.map((t) => ({
          ...
          position: t.n,
          byArtist: { "@type": "MusicGroup", name: "MALI" },
        })),
      }
    : {
        ...base,
